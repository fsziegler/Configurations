...
echo
echo === Download Eclipse CDT Juno
wget http://www.gtlib.gatech.edu/pub/eclipse/technology/epp/downloads/release/juno/SR2/eclipse-cpp-juno-SR2-linux-gtk.tar.gz
tar -vxzf eclipse-cpp-juno-SR2-linux-gtk.tar.gz
rm -f eclipse-cpp-juno-SR2-linux-gtk.tar.gz
echo
